...
class HomePostCell: UICollectionViewCell {
    ...
    var post : Post? {
        didSet{
            ...
            likeButton.setImage(post?.hasLiked == true ? #imageLiteral(resourceName: "like_selected").withRenderingMode(.alwaysOriginal) : #imageLiteral(resourceName: "like").withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    override init(frame: CGRect) {
        ...
        optionButton.anchor(top: topAnchor, left: nil, bottom: photoImageView.topAnchor, right: trailingAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 44, height: 0)
        userNameLabel.anchor(top: topAnchor, left: userProfileImageView.trailingAnchor, bottom: photoImageView.topAnchor, right: optionButton.leadingAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
    ...
    fileprivate func setupActionButton() {
        ...
        stackView.anchor(top: photoImageView.bottomAnchor, left: leadingAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 120, height: 50)
